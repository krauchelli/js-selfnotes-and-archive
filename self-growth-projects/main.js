...
const greatAuthorsFilter = books.filter(penjualanTotal => penjualanTotal.sales > 1000000);
console.log(greatAuthorsFilter);

const greatAuthors = greatAuthorsFilter.map((name) => {return `${name.author} adalah penulis buku ${name.title} yang sangat hebat!`});
